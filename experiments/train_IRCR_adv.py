...
###################################
        obs_temp, action_temp, rew_temp, new_obs_temp, done_temp, terminal_temp = [], [], [], [], [], []
...
###############################################
                for i, agent in enumerate(trainers):
                    if i > 0:
                        ...
                        agent.replay_buffer.min = 0
                        agent.replay_buffer.max = 1
                        for tt in range(arglist.max_episode_len):

                            agent.experience(obs_temp[tt][i], action_temp[tt][i], rew_temp[tt][i], new_obs_temp[tt][i], done_temp[tt][i], terminal_temp[tt])
